...
import { AttachmentsIcon, EmojiIcon, FileUploadIcon } from "@utilities/icons";
...
export const DiscussionDetailScreen = ({ discussion, tokens }: DiscussionDetailScreenProps) => {
  ...
  return (
    <div className={`flex flex-col flex-1 min-h-0 ${tokens.cardBase} rounded-2xl overflow-hidden`}>
      {/* Header */}
      <div className={`flex items-center justify-between px-6 py-4 ${tokens.isDark ? "border-white/10" : "border-gray-200"} flex-shrink-0`}>
      ...
      {/* Message Input */}
      <div className={`flex-shrink-0 px-6 py-4 border-t ${tokens.isDark ? "border-white/10" : "border-gray-200"}`}>
        <div
