...
export const TwoFactorAuthModal = ({
  ...
  const [_email, setEmail] = useState(initialEmail);
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
          ...
          {/* Modal */}
          <div className={`relative w-full max-w-lg ${tokens.cardBase} rounded-2xl p-6 max-h-[90vh] overflow-hidden flex flex-col`}>
            {/* Header */}
