...
export const LandingHero = () => {
  ...
  return (
    <section className="mx-auto max-w-4xl space-y-8 rounded-3xl bg-slate-900/60 px-8 py-16 text-slate-100 shadow-xl shadow-slate-900/30 ring-1 ring-slate-800">
